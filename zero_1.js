...
function btn1(){
    ...
    if (y5=="甲") {
       if (y6=="子") {
          document.getElementById("btn1").innerHTML="戌亥"; 
          } else if (y6=="寅"){
          document.getElementById("btn1").innerHTML="子丑";
          } else if (y6=="辰"){
          document.getElementById("btn1").innerHTML="寅卯";
          } else if (y6=="午"){
          document.getElementById("btn1").innerHTML="辰巳";
          } else if (y6=="申"){
          document.getElementById("btn1").innerHTML="午未";
          } else if (y6=="戌"){
          document.getElementById("btn1").innerHTML="申酉";
          }
    } else if (y5=="乙"){
        if (y6=="丑"){
          document.getElementById("btn1").innerHTML="戌亥";
...
function btn2(){
    ...
    if (y1=="甲") {
       if (y2=="子") {
          document.getElementById("btn2").innerHTML="戌亥"; 
          } else if (y2=="寅"){
          document.getElementById("btn2").innerHTML="子丑";
          } else if (y2=="辰"){
          document.getElementById("btn2").innerHTML="寅卯";
          } else if (y2=="午"){
          document.getElementById("btn2").innerHTML="辰巳";
          } else if (y2=="申"){
          document.getElementById("btn2").innerHTML="午未";
          } else if (y2=="戌"){
          document.getElementById("btn2").innerHTML="申酉";
          }
    } else if (y1=="乙"){
        if (y2=="丑"){
          document.getElementById("btn2").innerHTML="戌亥";
